...
namespace ApogeeApp1.Data
{
    ...
    {
        public SampleDataItem(String uniqueId, String title, String imagePath)
        {
    ...
    {
        public SampleDataSubItem(String uniqueId, String title, String imagePath,String overview, String rules, String eligibility, String guidelines, String judgingCriteria, String problemStatements, 
            String resources, String sampleQ, String specifications, String materials, String registrationDetails, String faqs, String sponsors, String contacts)
        {
            this.UniqueId = uniqueId;
            this.Title = title;
           // this.Subtitle = subtitle;
                        ...
                        foreach (JsonValue subitemValue in itemObject["SubItems"].GetArray())
                        {
                            ...
                            group.Items[i].SubItems.Add(new SampleDataSubItem(subitemObject["UniqueId"].GetString(),
                                                             ...
                                                             // subitemObject["Subtitle"].GetString(),
                                                               ...
                                                               subitemObject["Overview"].GetString(),
                                                               subitemObject["Rules"].GetString(),
                                                               subitemObject["Eligibility"].GetString(),
                                                               subitemObject["Guidelines"].GetString(),
                                                               subitemObject["Judging Criteria"].GetString(),
                                                               subitemObject["Problem Statements"].GetString(),
                                                               subitemObject["Resources"].GetString(),
                                                               subitemObject["Sample Questions"].GetString(),
                                                               subitemObject["Specifications"].GetString(),
                                                               subitemObject["Materials"].GetString(),
                                                               subitemObject["Registration Details"].GetString(),
                                                               subitemObject["FAQs"].GetString(),
                                                               subitemObject["Sponsors"].GetString(),
                                                               subitemObject["Contacts"].GetString()
